...
import { useComposedRefs } from "@same-room-different-life/ui/lib/compose-refs";
...
type Orientation = keyof typeof orientationConfig;
...
function SortableItemHandle(props: SortableItemHandleProps) {
  const { asChild, disabled, render, className, ref, ...itemHandleProps } =
    props;
